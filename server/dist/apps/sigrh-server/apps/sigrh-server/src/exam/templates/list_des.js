...
exports.getPdfCodes = exports.getPdfListDes = void 0;
const gen_dep_array_1 = require("./gen-dep-array");
const getPdfListDes = (data, params, field) => `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    ...
    ${(0, gen_dep_array_1.genListArray)(data, field.id)}
    
  </body>
</html>
`;
exports.getPdfListDes = getPdfListDes;
const getPdfCodes = (data, field) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
...
<body>
    ${(0, gen_dep_array_1.genCodeArray)(data, field)}
</body>
</html>`;
exports.getPdfCodes = getPdfCodes;
//# sourceMappingURL=list_des.js.map