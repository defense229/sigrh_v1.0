...
let DepartementService = class DepartementService extends repository_1.RepositoryService {
...
DepartementService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(departement_dto_1.Departement.name)),
